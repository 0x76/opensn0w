...
int main(int argc, char *argv[], char *env[])
{
	...
	printf("We are running on a %s! ... Checking status: ", platform);

	/* check against supported devices */

	if (!strcmp(platform, "iPod4,1")) {
		printf("supported.\n");
	} else if (!strcmp(platform, "iPod3,1")) {
		printf("supported.\n");
	} else if (!strcmp(platform, "iPhone2,1")) {
		printf("supported.\n");
	} else if (!strcmp(platform, "iPhone3,1")) {
		printf("supported.\n");
	} else if (!strcmp(platform, "iPhone3,3")) {
		printf("supported.\n");
	} else if (!strcmp(platform, "iPad1,1")) {
		printf("supported.\n");
	} else {
		printf("unsupported.\n");
		return -1;
