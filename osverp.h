...
/*--------------------------------------------------------------*/
#define VER_DDK_PRODUCTVERSION       1,00
#define VER_DDK_PRODUCTVERSION_STR  "1.00"
...
#define VER_COMPANYNAME_STR         "Velocity Limitless Organization"
#define VER_PRODUCTNAME_STR         "Velocity Limitless Organization"
#define VER_LEGALTRADEMARKS_STR     "opensn0w (R) is a registered trademark of Velocity Limitless Organization."
