...
unsigned char s5l8930x_image_raw_jump_bin[] = {
	...
	
};

unsigned int s5l8930x_image_raw_jump_bin_len = 164;
...
int limera1n()
{
	...
	memcpy(bootrom_dump_sc + sizeof(limera1n_dump_bootrom),
	       &limera1n_dump_bootrom_addresses[0], sizeof(uint32_t));
	...
	if (device->chip_id == 8930) {
		...
		memcpy(bootrom_dump_sc, limera1n_dump_bootrom,
		       sizeof(limera1n_dump_bootrom));
		memcpy(bootrom_dump_sc + sizeof(limera1n_dump_bootrom),
		       &limera1n_dump_bootrom_addresses[1], sizeof(uint32_t));
	}
